...
/**
 * Servlet implementation class AdminBlogServlet
 */
...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
        ...
        if(idRole == null){
        	...
        	if(idRole == 1) {
            	...
            	this.getServletContext().getRequestDispatcher("/WEB-INF/administration/admin-blog.jsp").forward(request, response);        	
            }else {
            	// If idRole isn't set, forbid access
            	response.sendRedirect("home");
            }
